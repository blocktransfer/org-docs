...
The embedded PDF is the complete public response and includes its table of contents, examination findings, supporting analysis, and referenced materials.

<iframe className="exam-pdf-frame" src="/exams/8.pdf" title="Examination Response #8 PDF" loading="lazy" />
