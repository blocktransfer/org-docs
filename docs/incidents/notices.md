...
If mail is not deliverable at any known investor addresses, the account enters our lost investor search policy.[^migration] Emails that soft bounce will be retried until succeeding or falling back to physical mail. Letters will be printed at the TA-1 location in fully opaque envelopes which reveal no personal content information.
...
[^migration]: To migrate from the compliance site. (Not the public policy, but the actual procedures and service operations.) This requires both database reengineering and the contract funding.
